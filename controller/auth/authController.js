...
exports.checkForgotPassword =async(req,res)=>{
  // const arrayOfEmails =["bikrambhattarai296@gmail.com","bhattaraijitenn@gmail.com"] //bulk ma email
  const email=req.body.email
  if(!email){
    return res.send("please provide email")
  }
  // if email  users table ma check that email
...
if(emailExists.length == 0){
  ...
  await  sendEmail({
    ...
    await emailExists[0].save() //database ma permanentlu rakhna lai save method use
